            <div class="app-content main-content">
                    <div class="side-app">
                        ...
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">Partner</h4>
                            </div>
                        </div>
                        <!--End Page header-->
                        <!-- Row-1 -->
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header d-flex justify-content-between">
                                        <h4 class="page-title mb-0 text-primary">Partner List</h4>
									</div>
									<div class="card-body">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="formData" action="<?= base_url('Home/updatePartnerWallet');?>" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3">
                ...
                <script src="<?= base_url();?>assets/ajax/partner.js"></script>